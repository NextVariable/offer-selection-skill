# SOE, central-SOE, and public-system path

Begin with current target-employer and target-position rules, not prestige comparison. Separate monopoly/regulated SOEs, market-oriented SOEs, headquarters, finance institutions, local units, and public-system recruitment.

Research degree-awarding institution, Chinese credential recognition, level-one/level-two discipline, likely credential name, accepted-major directory, school/ranking lists (QS/THE/U.S. News or employer-specific), graduation/fresh-graduate dates, age, degree, licensing, and other explicit gates.
